...
public class QuizPrototype : MonoBehaviour {
    ...
    public string Quiz30 = "W:20% X:1個  Y:2個";
   ...
   //         }
    ...
    void Question27() { AnswerA.text = "W:20% X:1個  Y:2個"; Questionlabel.text = "図に示す導体幅が0.99～0.50mmの欠損部分は最小導体間げきを満足し、かつ設計導体間隙値の(w)以下でその部分の設計導体間隙げきを超えない事、個数(1導体(X)個以下、100×100m中に(Y)個以下）とする。"; array = new string[]{ "W:20% X:1個  Y:2個", "W:25%  X:2個、Y:2個","W:30%。X:1個、Y:2個","W:20%以下  X:2個  Y:2個"}; }
